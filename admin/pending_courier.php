...
$query = "SELECT * FROM booking  join status_table on booking.status_id_FK=status_table.status_id where status_id_FK='1'";
...
$result1 = mysqli_query($con,$query1);
  ...
  $query = "SELECT * FROM booking  join branch on booking.pickup_branch_id_fk=branch.branch_id join status_table on booking.status_id_FK=status_table.status_id where status_id_FK='1'  AND pickup_branch_id_fk='$a4'";
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card-style mb-30">
                  <h6 class="mb-10">pending Table</h6>
